...
const API_URL = "https://maadhyam-backend.onrender.com";
...
const deleteComment = async (id) => {
  try {
    let response = await axios.delete(`${API_URL}/comment/delete/${id}`, {
      headers: {
        authorization: getAccessToken(),
      },
    });
    ...
    return { isFailure: true, msg: "Error deleting comment" };
  }
};

export { API, deletePost, deleteComment };
